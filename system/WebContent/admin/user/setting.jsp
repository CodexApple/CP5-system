                    	...
                    	<div class="row">
                        	<div class="col-xl-12">
                            	<div class="card p-r-0">
                                	<div class="card-body">
                                    	<h4 class="box-title text-color">User List
                                    	<button onclick="document.getElementById('id01').style.display='block'" style="width:auto; border:none; background:none; color:White; position:relative; left:85%;">Add Users</button></h4>
                 							<div id="id01" class="modal">
				 								<form class="modal-content animate" action="../../assets/command/user/create.jsp" method="post">
				 									<div class="imgcontainer p-b-10 p-l-10 text-color2">User Form</div>
														<div class="container-2">
															<label class="text-color2">Username:</label><br />
																<input type="text" placeholder="Enter your username" name="username" required style="width: 16em; background:transparent; color:white; border:none; border-bottom:3px black solid"><br /><br />
															<label class="text-color2">Password:</label><br />
																<input type="password" placeholder="Enter your password" name="password" required style="width: 16em; background:transparent; color:white; border:none; border-bottom:3px black solid"><br /><br />
															<label class="text-color2">Repeat Password:</label><br />
																<input type="password" placeholder="Repeat your password" name="cpassword" required style="width: 16em; background:transparent; color:white; border:none; border-bottom:3px black solid"><br /><br />
															<label class="text-color2">Email:</label><br />
																<input type="email" placeholder="Enter your email" name="email" required style="width: 16em; background:transparent; color:white; border:none; border-bottom:3px black solid"><br /><br />
															<div>
														...
														<div class="center-class">
															<button type="submit" class="container-3 text-color2">Create Account</button>
														</div>
													</div>
												</form>
											</div>
                                        		...
                                        		<table class="table">
                                            		...
                                            		<tbody>
                                            			<tr>
                                            				...
                                            				<td>${u.getStatus()}</td>
                                            				<td><a class="text-color" href="../../assets/setting/u_editform.jsp?id=${u.getId()}">Edit</a></td>
                                            				<td><a class="text-color" href="commands/user_delete.jsp?id=${u.getId()}">Delete</a></td>
                                            			</tr>
                                            		</tbody>
                                            			</c:forEach>
                                        		</table>
